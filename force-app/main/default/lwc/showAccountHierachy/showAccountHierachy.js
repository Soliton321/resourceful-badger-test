...
import getAccounts from "@salesforce/apex/DisplayAccountHierachyCtrl.getCurrentHierarchy";
import { ShowToastEvent } from "lightning/platformShowToastEvent";
const ERROR_TITLE = "Error";
const ERROR_VARIANT = "error";

export default class ShowAccountHierachy extends LightningElement {
  @api recordId;
  parentChildrenPairs;
  @wire(getAccounts, { accountId: "$recordId" })
  getAccounts(result) {
    if (result) {
      this.parentChildrenPairs = result;
      ...
      this.parentChildrenPairs = undefined;
    }
  }
